...
- **CONCERNS** → surface the specific ADRs or recommendations flagged; use `ask_user` with options: `Revise the impact assessment` / `Accept with noted concerns` / `Discuss further`
